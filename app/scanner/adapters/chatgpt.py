...
class ChatGPTAdapter:
    ...
    #
    # 10–15 с — компромисс, выбранный 17.09.2026: в режиме «Быстро» (2–5 с)
    # ChatGPT перекрывал поле ввода плашкой «слишком часто», а 15–35 с
    # растягивали прогон почти вдвое. Если плашка вернётся, её пережидает
